...
{
    internal class Day03 : IAocResults
    {
        public static async Task<ITuple> PartOneAndTwo() => (await PartOne(), await PartTwo());

        async static Task<int> PartOne() => (await File.ReadAllLinesAsync("./Data/Day03.txt"))
        ...
        async static Task<int> PartTwo() => (await File.ReadAllLinesAsync("./Data/Day03.txt"))
            .Chunk(3)
